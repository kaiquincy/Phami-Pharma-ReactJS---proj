                ...
                user ? (
                    <>
                        <div className="flex items-center justify-end space-x-4">
                            ...
                            <img src="https://cdn-icons-png.flaticon.com/512/236/236832.png"  className="w-10 h-10 rounded-full" />

                            <p className="text-gray-700 poppins hidden md:block lg:block">{user.username}</p>
